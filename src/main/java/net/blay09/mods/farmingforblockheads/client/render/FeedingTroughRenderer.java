...
public class FeedingTroughRenderer extends TileEntityRenderer<TileFeedingTrough> {
	...
	@Override
	public void render(TileFeedingTrough tileEntity, double x, double y, double z, float partialTicks, int destroyStage) {
