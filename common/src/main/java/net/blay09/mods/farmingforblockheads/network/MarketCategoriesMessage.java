...
public class MarketCategoriesMessage implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.Type<MarketCategoriesMessage> TYPE = new CustomPacketPayload.Type(new ResourceLocation(FarmingForBlockheads.MOD_ID,
            "market_categories"));
